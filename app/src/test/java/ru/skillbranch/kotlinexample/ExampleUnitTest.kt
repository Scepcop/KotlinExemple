...
class ExampleUnitTest {
    ...
    fun register_user_by_phone_success() {
        val holder = UserHolder
        val user = UserHolder.registerUserByPhone("John Doe", "+7 (917) 971 11-11")
        val expectedInfo = """
            firstName: John
            lastName: Doe
            login: +79179711111
    ...
    fun register_user_by_phone_fail_blank() {
        val holder = UserHolder
        UserHolder.registerUserByPhone("", "+7 (917) 971 11-11")
    }

    @Test(expected = IllegalArgumentException::class)
    fun register_user_by_phone_fail_illegal_name() {
        val holder = UserHolder
        UserHolder.registerUserByPhone("John Doe", "+7 (XXX) XX XX-XX")
    }

    @Test(expected = IllegalArgumentException::class)
    fun register_user_failby_phone_illegal_exist() {
        val holder = UserHolder
        UserHolder.registerUserByPhone("John Doe", "+7 (917) 971-11-11")
        UserHolder.registerUserByPhone("John Doe", "+7 (917) 971-11-11")
    }
